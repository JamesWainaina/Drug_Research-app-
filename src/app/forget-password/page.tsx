      ...
      <DefaultLayout>
        <div className="mt-20 h-screen text-center">
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="mx-auto max-w-md">
                ...
                <div className="mb-6">
                    ...
                    className="w-full cursor-pointer roundes-lg border
                     border-primary bg-primary p-4 text-white transition hover:bg-opacity-90" />
                </div>
              </form>
            </>
          )}
          ...
          {status === "success" && (
            ...
            <p className="mb-6"> 
                We have sent a password reset link to your {email}. Click the link to reset your password.
            </p>
            <button
