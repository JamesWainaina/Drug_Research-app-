...
import { createMoleculeGenerationHistory, fetchMolecules, getMoleculeGenerationHistoryByUser } from "@/lib/actions/molecule-generation.action";
...
const ModalLayout = () => {
 ...
 const handleSubmit = async (e: any) => {
   ...
   try {
     const generatedMolecules = await fetchMolecules(payload); // Call the proxy function
