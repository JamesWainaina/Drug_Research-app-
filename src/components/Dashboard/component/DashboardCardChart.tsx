        ...
        <div className="mb-2">
          <div id="chartThree" className="mx-auto flex justify-center">
            <div className="flex items-start gap-2.5">
              <img className="h-8 rounded-full" src="/images/user/user-01.png" alt="Jese image" />
              <div className="leading-1.5 border-gray-200 dark:bg:gray-700 flex-col rounded-e-xl rounded-es-xl bg-[#f3f4f6] p-4">
